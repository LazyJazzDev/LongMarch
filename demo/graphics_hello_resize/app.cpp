...
void Application::OnInit() {
  ...
  core_->CreateBuffer(sizeof(GlobalUniformBuffer), CD::graphics::BUFFER_TYPE_DYNAMIC, &uniform_buffer_);
  ...
  window_->ResizeEvent().RegisterCallback([this](int width, int height) {
    ...
    core_->CreateImage(width, height, CD::graphics::IMAGE_FORMAT_D32_SFLOAT, &depth_image_);
  });
