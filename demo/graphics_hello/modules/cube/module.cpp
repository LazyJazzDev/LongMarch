...
void ModuleCube::OnInit() {
  ...
  core_->CreateShader(LoadShader("modules/cube/shaders/shader.slang"), "VSMain", "vs_6_0", &vertex_shader_);
  core_->CreateShader(LoadShader("modules/cube/shaders/shader.slang"), "PSMain", "ps_6_0", &fragment_shader_);
