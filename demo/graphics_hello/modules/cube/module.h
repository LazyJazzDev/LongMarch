...
class ModuleCube final : public Module {
 public:
  ModuleCube(grassland::graphics::BackendAPI api = grassland::graphics::BACKEND_API_DEFAULT);
 ...
 private:
  ...
  std::unique_ptr<grassland::graphics::Buffer> uniform_buffer_;
