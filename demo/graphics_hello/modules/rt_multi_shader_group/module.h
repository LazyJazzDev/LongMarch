...
class ModuleRTMultiShaderGroup final : public Module {
 public:
  ModuleRTMultiShaderGroup(grassland::graphics::BackendAPI api = grassland::graphics::BACKEND_API_DEFAULT);

  ~ModuleRTMultiShaderGroup() override;
