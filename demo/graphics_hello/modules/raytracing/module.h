...
class ModuleRayTracing final : public Module {
 public:
  ModuleRayTracing(grassland::graphics::BackendAPI api = grassland::graphics::BACKEND_API_DEFAULT);

  ~ModuleRayTracing() override;
