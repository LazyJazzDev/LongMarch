...
namespace graphics_hello::triangle {

ModuleTriangle::ModuleTriangle(grassland::graphics::BackendAPI api) {
  InitializeGraphicsHello(api, core_);
}

ModuleTriangle::~ModuleTriangle() = default;

void ModuleTriangle::OnInit() {
  alive_ = true;
