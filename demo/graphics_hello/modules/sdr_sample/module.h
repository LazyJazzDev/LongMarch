...
class ModuleSDRSample final : public Module {
 public:
  ModuleSDRSample(grassland::graphics::BackendAPI api = grassland::graphics::BACKEND_API_DEFAULT);

  ~ModuleSDRSample() override;
