...
int main() {
  ...
  XH::Film film(&xh_core, 2048, 1024);
  ...
  XH::MaterialPrincipled material_matball0(&xh_core, {0.8f, 0.8f, 0.8f});
  ...
  XH::EntityGeometryMaterial entity_matball0(&xh_core, &geometry_matball, &material_matball0,
                                             glm::translate(glm::mat4{1.0f}, glm::vec3{-2.2f, 0.0f, 0.0f}));
  scene.AddEntity(&entity_matball0);

  XH::MaterialPrincipled material_matball1(&xh_core, {0.8f, 0.8f, 0.8f});
  ...
  XH::EntityGeometryMaterial entity_matball1(&xh_core, &geometry_matball, &material_matball1,
                                             glm::translate(glm::mat4{1.0f}, glm::vec3{0.0f, 0.0f, 0.0f}));
  scene.AddEntity(&entity_matball1);

  XH::MaterialPrincipled material_matball2(&xh_core, {0.8f, 0.8f, 0.8f});
  ...
  XH::EntityGeometryMaterial entity_matball2(&xh_core, &geometry_matball, &material_matball2,
                                             glm::translate(glm::mat4{1.0f}, glm::vec3{2.2f, 0.0f, 0.0f}));
  scene.AddEntity(&entity_matball2);

  XH::MaterialPrincipled material_matball3(&xh_core, {1.0f, 1.0f, 1.0f});
  material_matball3.roughness = 0.1f;
  material_matball3.transmission = 1.0f;
  material_matball3.ior = 1.3f;
  XH::EntityGeometryMaterial entity_matball3(&xh_core, &geometry_matball, &material_matball3,
  ...
  XH::EntityAreaLight area_light(&xh_core, glm::vec3{1.0f, 1.0f, 1.0f}, 1.0f, glm::vec3{0.0f, 30.0f, 50.0f},
