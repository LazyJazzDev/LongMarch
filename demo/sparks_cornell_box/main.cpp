...
int main() {
  ...
  XH::EntityGeometryMaterial entity_tall_box(&sparks_core, &geometry_tall_box, &material_white);
  ...
  while (!window->ShouldClose()) {
    ...
    window->SetTitle(std::string("Sparks Cornell Box - ") + fps_buf + "frames/s" + " - " + rps_buf + "Mrays/s");
  }
