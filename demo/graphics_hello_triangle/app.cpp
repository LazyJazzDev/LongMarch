...
void Application::OnInit() {
  ...
  core_->CreateImage(1280, 720, CD::graphics::IMAGE_FORMAT_R8G8B8A8_UNORM, &color_image_);
  ...
  core_->CreateProgram({color_image_->Format()}, CD::graphics::IMAGE_FORMAT_UNDEFINED, &program_);
...
void Application::OnRender() {
  ...
  if (first_frame_) {
    ...
    stbi_write_bmp((((core_->API() == CD::graphics::BACKEND_API_VULKAN) ? "vulkan_" : "d3d12_") +
