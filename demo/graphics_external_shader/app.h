...
class Application {
 ...
 private:
  ...
  std::unique_ptr<CD::graphics::Shader> sphere_intersection_shader_;
  std::unique_ptr<CD::graphics::Shader> sphere_closest_hit_shader_;

  std::unique_ptr<CD::graphics::Shader> callable_shader_;

  std::unique_ptr<CD::graphics::AccelerationStructure> triangle_blas_;
  std::unique_ptr<CD::graphics::AccelerationStructure> sphere_blas_;
