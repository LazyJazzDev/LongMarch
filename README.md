...
Shaders are compiled with Slang 2026.18.3 or newer. CMake uses a compatible SDK
package or downloads a pinned official release; see [shader compilation and migration](docs/slang-shaders.md).
