...
#define SP_TEXTURE(T) ComputeTexture_##T
#define SP_RW_TEXTURE(T) ComputeTexture_##T
#define SP_SAMPLER ComputeSamplerState
#ifdef SPARKIUM_OPTIX
#define SP_RAY RayDesc
#else
#define SP_RAY ComputeRayDesc
#endif
#define SP_NONUNIFORM(i) (i)
#define SP_IMAGE_FORMAT(f)
#define SP_RESOURCE(T, name, reg, slot) [ComputeBinding(slot)] T name
#define SP_ARRAY_RESOURCE(T, name, reg, slot) [ComputeBinding(slot)] ComputeArray<T> name
#else
...
#define SP_RESOURCE_ACCESS(T, name, slot) ComputeResource<T>(compute_context, slot)
#define SP_ARRAY_ACCESS(T, name, slot) ComputeResource<ComputeArray<T>>(compute_context, slot)
#define SP_CONTEXT ComputeContext *compute_context,
#define SP_CONTEXT_ONLY ComputeContext *compute_context
#define SP_CONTEXT_ARG_ONLY compute_context
#define SP_CONTEXT_ARG compute_context,
