...
MaterialShaderGraph::MaterialShaderGraph(sparkium::MaterialShaderGraph &material)
  ...
  if (core_->UsesGraphicsRayTracing() &&
      (core_->GraphicsCore()->CreateShader(vfs, "geometry/mesh/hit_group.hlsl", "RenderClosestHit", "lib_6_5", {"-I."},
       ...
       core_->GraphicsCore()->CreateShader(vfs, "geometry/mesh/hit_group.hlsl", "ShadowAnyHit", "lib_6_5", {"-I."},
...
const CodeLines *MaterialShaderGraph::GraphImpl() const { return &material_.graph_code; }
