...
MaterialLambertian::MaterialLambertian(sparkium::MaterialLambertian &material)
  ...
  core_->BackendDevice()->CreateShader(core_->GetShadersVFS(), "material/lambertian/pixel_shader.hlsl", "PSMain",
                                       "ps_6_0", &pixel_shader_);
  core_->BackendDevice()->CreateBuffer(sizeof(glm::vec3) + sizeof(glm::vec3), graphics::BUFFER_TYPE_STATIC,
                                       &material_buffer_);
}
