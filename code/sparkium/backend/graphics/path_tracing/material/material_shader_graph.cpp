#include "sparkium/backend/graphics/path_tracing/material/material_shader_graph.h"
...
MaterialShaderGraph::MaterialShaderGraph(sparkium::MaterialShaderGraph &material)
  ...
  if (core_->UsesGraphicsRayTracing() &&
      (core_->BackendDevice()->CreateShader(vfs, "geometry/mesh/hit_group.hlsl", "RenderClosestHit", "lib_6_5", {"-I."},
                                            &closest_hit_shader_) != 0 ||
       core_->BackendDevice()->CreateShader(vfs, "geometry/mesh/hit_group.hlsl", "ShadowClosestHit", "lib_6_5", {"-I."},
                                            &shadow_closest_hit_shader_) != 0 ||
       core_->BackendDevice()->CreateShader(vfs, "geometry/mesh/hit_group.hlsl", "ShadowAnyHit", "lib_6_5", {"-I."},
