#pragma once
#include "sparkium/backend/graphics/material_codegen.h"
#include "sparkium/backend/graphics/path_tracing/core/core_util.h"

namespace sparkium::raytracing {

// Graphics compute path tracer with software BVH or inline Ray Query.
class SoftwarePipeline {
 ...
 private:
  ...
  using MaterialCode = backend::graphics_backend::MaterialCode;
