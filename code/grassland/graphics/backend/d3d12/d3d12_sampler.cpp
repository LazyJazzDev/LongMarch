...
D3D12Sampler::D3D12Sampler(D3D12Core *core, const SamplerInfo &info) : core_(core) {
  sampler_desc_.Filter = FilterModeToD3D12Filter(info.min_filter, info.mag_filter, info.mip_filter);
