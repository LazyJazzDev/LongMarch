...
void ImGui_ImplMetal_RenderDrawData(ImDrawData* drawData, id<MTLCommandBuffer> commandBuffer, id<MTLRenderCommandEncoder> commandEncoder)
{
    ...
    size_t vertexBufferLength = (size_t)drawData->TotalVtxCount * sizeof(grassland::imgui::GPUVertex);
    ...
    for (int n = 0; n < drawData->CmdListsCount; n++)
    {
        ...
        for (int cmd_i = 0; cmd_i < draw_list->CmdBuffer.Size; cmd_i++)
        {
            ...
            else
            {
                ...
                [commandEncoder setVertexBufferOffset:(vertexBufferOffset + pcmd->VtxOffset * sizeof(grassland::imgui::GPUVertex)) atIndex:0];
        ...
        vertexBufferOffset += (size_t)draw_list->VtxBuffer.Size * sizeof(grassland::imgui::GPUVertex);
...
- (id<MTLRenderPipelineState>)renderPipelineStateForFramebufferDescriptor:(FramebufferDescriptor*)descriptor device:(id<MTLDevice>)device
{
    ...
    vertexDescriptor.attributes[0].offset = offsetof(grassland::imgui::GPUVertex, pos);
    vertexDescriptor.attributes[0].format = MTLVertexFormatFloat2; // position
    vertexDescriptor.attributes[0].bufferIndex = 0;
    vertexDescriptor.attributes[1].offset = offsetof(grassland::imgui::GPUVertex, uv);
    vertexDescriptor.attributes[1].format = MTLVertexFormatFloat2; // texCoords
    vertexDescriptor.attributes[1].bufferIndex = 0;
    vertexDescriptor.attributes[2].offset = offsetof(grassland::imgui::GPUVertex, col);
    vertexDescriptor.attributes[2].format = MTLVertexFormatFloat4; // color
    vertexDescriptor.attributes[2].bufferIndex = 0;
    vertexDescriptor.layouts[0].stepRate = 1;
    vertexDescriptor.layouts[0].stepFunction = MTLVertexStepFunctionPerVertex;
    vertexDescriptor.layouts[0].stride = sizeof(grassland::imgui::GPUVertex);
