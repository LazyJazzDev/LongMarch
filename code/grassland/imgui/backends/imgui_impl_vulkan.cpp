...
void ImGui_ImplVulkan_RenderDrawData(ImDrawData* draw_data, VkCommandBuffer command_buffer, VkPipeline pipeline)
{
    ...
    if (draw_data->TotalVtxCount > 0)
    {
        ...
        VkDeviceSize vertex_size = AlignBufferSize(draw_data->TotalVtxCount * sizeof(grassland::imgui::GPUVertex), bd->BufferMemoryAlignment);
        ...
        grassland::imgui::GPUVertex* vtx_dst = nullptr;
...
static void ImGui_ImplVulkan_CreatePipeline(VkDevice device, const VkAllocationCallbacks* allocator, VkPipelineCache pipelineCache, VkRenderPass renderPass, VkSampleCountFlagBits MSAASamples, VkPipeline* pipeline, uint32_t subpass)
{
    ...
    binding_desc[0].stride = sizeof(grassland::imgui::GPUVertex);
    ...
    attribute_desc[0].offset = offsetof(grassland::imgui::GPUVertex, pos);
    attribute_desc[1].location = 1;
    attribute_desc[1].binding = binding_desc[0].binding;
    attribute_desc[1].format = VK_FORMAT_R32G32_SFLOAT;
    attribute_desc[1].offset = offsetof(grassland::imgui::GPUVertex, uv);
    attribute_desc[2].location = 2;
    attribute_desc[2].binding = binding_desc[0].binding;
    attribute_desc[2].format = VK_FORMAT_R32G32B32A32_SFLOAT;
    attribute_desc[2].offset = offsetof(grassland::imgui::GPUVertex, col);
