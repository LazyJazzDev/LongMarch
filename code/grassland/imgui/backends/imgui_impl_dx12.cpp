...
static void ImGui_ImplDX12_SetupRenderState(ImDrawData* draw_data, ID3D12GraphicsCommandList* command_list, ImGui_ImplDX12_RenderBuffers* fr)
{
    ...
    unsigned int stride = sizeof(grassland::imgui::GPUVertex);
...
void ImGui_ImplDX12_RenderDrawData(ImDrawData* draw_data, ID3D12GraphicsCommandList* command_list)
{
    ...
    if (fr->VertexBuffer == nullptr || fr->VertexBufferSize < draw_data->TotalVtxCount)
    {
        ...
        desc.Width = fr->VertexBufferSize * sizeof(grassland::imgui::GPUVertex);
        desc.Height = 1;
    ...
    if (fr->IndexBuffer->Map(0, &range, &idx_resource) != S_OK)
        return;
    grassland::imgui::GPUVertex* vtx_dst = (grassland::imgui::GPUVertex*)vtx_resource;
    ...
    IM_ASSERT(range.End == draw_data->TotalVtxCount * sizeof(grassland::imgui::GPUVertex));
...
bool    ImGui_ImplDX12_CreateDeviceObjects()
{
    ...
    // Create the vertex shader
    {
        ...
        {
            { "POSITION", 0, DXGI_FORMAT_R32G32_FLOAT,   0, (UINT)offsetof(grassland::imgui::GPUVertex, pos), D3D12_INPUT_CLASSIFICATION_PER_VERTEX_DATA, 0 },
            { "TEXCOORD", 0, DXGI_FORMAT_R32G32_FLOAT,   0, (UINT)offsetof(grassland::imgui::GPUVertex, uv),  D3D12_INPUT_CLASSIFICATION_PER_VERTEX_DATA, 0 },
            { "COLOR",    0, DXGI_FORMAT_R32G32B32A32_FLOAT, 0, (UINT)offsetof(grassland::imgui::GPUVertex, col), D3D12_INPUT_CLASSIFICATION_PER_VERTEX_DATA, 0 },
        };
