...
MaterialSpecular::MaterialSpecular(Core *core, const glm::vec3 &base_color) : Material(core), base_color(base_color) {
  ...
  power_sampler_implementation_ = CodeLines(core_->GetShadersVFS(), "material/specular/power_sampler.hlsli");
}
...
const CodeLines &MaterialSpecular::PowerSamplerImpl() const {
