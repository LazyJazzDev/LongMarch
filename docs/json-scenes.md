...
upload. Disabling reference-white alignment changes only the brightness
multiplier, not UI color conversion. Custom ImGui textures on the HDR path must supply linear RGB. Incoming
